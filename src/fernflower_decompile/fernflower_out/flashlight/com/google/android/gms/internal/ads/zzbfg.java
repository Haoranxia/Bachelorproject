...
@VisibleForTesting
final class zzbfg extends zzbfm implements OnGlobalLayoutListener, DownloadListener, zzaia, zzbdi {
   ...
   private final AtomicReference zzehx;
   private final DisplayMetrics zzwe;

   @VisibleForTesting
   protected zzbfg(zzbez param1, zzbfb param2, zzbey param3, String param4, boolean param5, boolean param6, zzdq param7, zzazb param8, zzaae param9, com.google.android.gms.ads.internal.zzi param10, com.google.android.gms.ads.internal.zza param11, zzsm param12, zzro param13, boolean param14) {
      // $FF: Couldn't be decompiled
   }

   // $FF: synthetic method
   static int zza(zzbfg param0) {
      // $FF: Couldn't be decompiled
   }

   // $FF: synthetic method
   static int zza(zzbfg param0, int param1) {
      // $FF: Couldn't be decompiled
   }
   ...
   protected final void zzbe(boolean param1) {
      // $FF: Couldn't be decompiled
   }
   ...
   public final void zzj(String param1, String param2) {
      // $FF: Couldn't be decompiled
   }
