...
final class zzpv implements ActivityLifecycleCallbacks {
   private final Application zzxa;
   private final WeakReference zzxb;
   private boolean zzxc;

   public zzpv(Application param1, ActivityLifecycleCallbacks param2) {
      // $FF: Couldn't be decompiled
   }

   private final void zza(zzqd param1) {
      // $FF: Couldn't be decompiled
   }
